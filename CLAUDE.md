...
- The CLI entry point is `cc-orch` (see `src/cli/index.js` for the command surface; `.claude/skills/cc-orch-operator/` is the AI-facing operator manual deployed with the package)
