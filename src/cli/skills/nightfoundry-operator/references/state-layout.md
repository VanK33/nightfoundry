...
<projectRoot>/
  ...
  .nightfoundry.json         ← optional project config override (.nightfoundry.json is still honored as a fallback)
  nightfoundry-guidance.md   ← machine-managed guidance file, regenerated by init
```
